                        ...
                        <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                            <div class="product">
                                <figure class="product-media">
                                    <a href="productdc08.html?ID=3">
                                        <img src="images/products/ICE_1028%20(1)%20(1).jpg" alt="Product" class="product-image" />
                                    </a>

                                    <div class="product-action action-icon-top">
                                        <a href="productdc08.html?ID=3" class="btn-product btn-cart"><span>add to cart</span></a>
                                ...
                                <div class="product-body">
                                    ...
                                    <h2 class="product-title"><a href="productdc08.html?ID=3">Heels</a></h2>
