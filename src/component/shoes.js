                        ...
                        <div class="row">
                                ...
                                <div class="product">
                                    <figure class="product-media">
                                                                                <a href="product53e5.html?ID=5">
                                            <img src="images/products/ICE_1100%20(2).jpg" alt="Product" class="product-image"/>
                                        </a>

                                        <div class="product-action action-icon-top">
                                            <a href="product53e5.html?ID=5" class="btn-product btn-cart"><span>add to cart</span></a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h2 class="product-title"><a href="product53e5.html?ID=5">Shoe</a></h2>
                                ...
                                <div class="product">
                                    <figure class="product-media">
                                                                                <a href="productdfb4.html?ID=1">
                                            <img src="images/products/ICE_1056%20(2).jpg" alt="Product" class="product-image"/>
                                        </a>

                                        <div class="product-action action-icon-top">
                                            <a href="productdfb4.html?ID=1" class="btn-product btn-cart"><span>add to cart</span></a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h2 class="product-title"><a href="productdfb4.html?ID=1">Shoe</a></h2>
                                        <div class="product-price">
                                            ₦15,000                                        </div>
